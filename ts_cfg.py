...
DIFIT_CFG = ArticulationCfg(
    spawn=sim_utils.UsdFileCfg(
        ...
        collision_props=sim_utils.CollisionPropertiesCfg(contact_offset=0.02, rest_offset=0.0),#res=0.0
    ),
...
SAW_DIGIT_R_CFG = ArticulationCfg(
    spawn=sim_utils.UsdFileCfg(
        ...
        collision_props=sim_utils.CollisionPropertiesCfg(contact_offset=0.005, rest_offset=0.0),#con==0.005 rest=0.0
    ),
    init_state=ArticulationCfg.InitialStateCfg(
        joint_pos={
            "right_j0": 0,
